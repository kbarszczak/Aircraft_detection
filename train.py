...
def train(train_dataloader, valid_dataloader, test_dataloader, vis_batches, batch_size, epochs, modules, model_name,
          model_version, data_path, target_path, height, width, save_freq, log_freq, device):
    ...
    utils.save_history_plot(plot_5_raw_loss_path, history, exclude=['psnr', 'mse', 'mae', 'ssim'], use_norm=False,
                            steps=5)
    ...
    utils.save_history_plot(plot_50_raw_loss_path, history, exclude=['psnr', 'mse', 'mae', 'ssim'], use_norm=False,
                            steps=50)
